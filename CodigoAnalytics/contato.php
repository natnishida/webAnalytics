        ...
        <nav class="navbar container navbar-expand-lg navbar-light p-0 p-lg-3">
              ...
              <div class="collapse navbar-collapse bg-white" style="z-index:10" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav mr-auto p-3 p-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="http://localhost/CodigoAnalytics/#categorias">A Cross373</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="http://localhost/CodigoAnalytics/#crosstraining">Sobre Crosstraining</a>
                  </li>
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <a class="dropdown-item" href="http://localhost/CodigoAnalytics/contato.php">Mande uma mensagem</a>
		...
		<footer class="page-footer font-small bg-dark" style="color:#FFF">
						...
						<div class="container text-center text-md-left mt-3">
							...
							<div class="col-md-4 mx-auto mb-4 links-footer ">
									...
									<hr class="bg-light accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
									<p>
										<a href="http://localhost/CodigoAnalytics/#categorias">Sobre a Cross 373</a>
									</p>
									<p>
										<a href="http://localhost/CodigoAnalytics/#crosstraining">Sobre Crosstraining</a>
									</p>
									<p>
							...
							<div class="footer-copyright text-center py-3">© 2018 Copyright:
								<a href="http://localhost/CodigoAnalytics">www.cross373.com</a>
							</div>
		</footer>
